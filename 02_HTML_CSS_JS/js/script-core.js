(function ($) {
  ...
  akea_sf_menu.prototype = {
    ...
    sf_menu_position: function () {
      ...
      var sub_normal_menu = this.main_menu.find(
        ".sf-menu > li.akea-normal-menu .sub-menu"
      );
      ...
      this.main_menu
        .find(".sf-menu > li.akea-mega-menu .sf-mega")
        .each(function () {
    ...
    init_slidebar: function () {
      ...
      t.main_menu
        ...
        .on({
          ...
          mouseleave: function () {
            t.slide_bar.animate(
              { width: 15, left: t.slide_bar_val.left },
              { queue: false, duration: 250 }
            );
          },
        });
      ...
      $(window).on("akea-navigation-slider-bar-animate", function () {
        t.animate_slidebar_pos();
      });
    }, // init_slidebar
    ...
    init_slidebar_pos: function () {
      ...
      if (t.current_menu.length > 0) {
        ...
        t.slide_bar_val = {
          width: 0,
          left: t.main_menu.children("ul").children("li:first-child").position()
            .left,
        };
      }
      t.slide_bar.css({
  ...
  $.fn.akea_mobile_menu = function (args) {
    ...
    $(this)
      ...
      .each(function () {
        ...
        $('<span class="akea-mm-menu-blank" ></span>')
          .html(content)
          .insertBefore($(this));
        $(this).remove();
      });
  ...
  akea_header_side_nav.prototype = {
          ...
          if (scroll_down) {
            ...
            if (!t.side_nav.hasClass("akea-fix-top")) {
              if (t.side_nav.hasClass("akea-fix-bottom")) {
                var top_pos =
                  $(window).scrollTop() +
                  ($(window).height() - admin_bar_height) -
                  t.side_nav_content.outerHeight();
                t.side_nav.css("top", top_pos);
                t.side_nav.removeClass("akea-fix-bottom");
              } else if (
                $(window).scrollTop() + admin_bar_height <
                t.side_nav_content.offset().top
              ) {
                if (!t.side_nav.hasClass("akea-fix-top")) {
    ...
    init_nav_bar_element: function () {
      ...
      var t = this;
      var middle_pos = t.side_nav_content
        .children(".akea-pos-middle")
        .addClass("akea-active");
      var bottom_pos = t.side_nav_content
        .children(".akea-pos-bottom")
        .addClass("akea-active");
      ...
      if ($(window).height() < t.side_nav_content.height()) {
        ...
        t.side_nav
          .removeClass("akea-allow-slide akea-fix-top akea-fix-bottom")
          .css("top", "");
        ...
        if (t.side_nav.hasClass("akea-style-middle")) {
          middle_pos.each(function () {
            ...
            var prespace =
              (t.side_nav.height() -
                (t.side_nav_content.height() - top_padding)) /
                2 -
              top_padding;

            if (prespace > 0) {
              $('<div class="akea-pre-spaces" ></div>')
                .css("height", prespace)
                .insertBefore($(this));
            }
          });
  ...
  var akea_anchor = function () {
    this.anchor_link = $('a[href*="#"]')
      ...
      .filter(function () {
        ...
        if (
          $(this).is(
            ".akea-mm-menu-button, .mm-next, .mm-prev, .mm-title, .gdlr-core-ilightbox"
          )
        ) {
          return false;
        }
        ...
        // for woocommerce
        if (
          $(this).parent(".description_tab, .reviews_tab").length ||
          $(this).not('[class^="akea"]').closest(".woocommerce").length
        ) {
          return false;
        }
    ...
    if (this.anchor_link.length) {
      ...
      this.home_anchor = this.menu_anchor.find(
        "ul.sf-menu > li.current-menu-item > a, ul.sf-menu > li.current-menu-ancestor > a, .akea-bullet-anchor-link.current-menu-item"
      );
  ...
  akea_anchor.prototype = {
    ...
    scroll_to: function (hash, redirect, duration) {
      ...
      if (typeof scroll_position != "undefined") {
        ...
        scroll_position =
          scroll_position - parseInt($("html").css("margin-top"));
        ...
        if (
          ...
          scroll_position =
            scroll_position - parseInt(window.akea_anchor_offset);
        }
    ...
    scroll_section: function () {
      ...
      var menu_link_anchor = this.menu_anchor
        .find('a[href*="#"]')
        .not('[href="#"]');
      ...
      $(window).scroll(function () {
        ...
        if (
          ...
          $(window).scrollTop() <= home_anchor_section.offset().top
        ) {
          t.home_anchor.each(function () {
            if ($(this).hasClass("akea-bullet-anchor-link")) {
              ...
              $(this)
                .parent(".akea-bullet-anchor")
                .attr("data-anchor-section", "akea-home");
            } else if (
              !$(this).parent(".current-menu-item, .current-menu-ancestor")
                .length
            ) {
              $(this)
                .parent()
          ...
          anchor_section.each(function () {
            ...
            if (
              section_position > top_offset_pos &&
              section_position < top_offset_pos + $(this).outerHeight()
            ) {
              var section_id = $(this).attr("id");
              menu_link_anchor
                .filter('[data-anchor="#' + section_id + '"]')
                .each(function () {
                  if ($(this).hasClass("akea-bullet-anchor-link")) {
                    $(this)
                      .addClass("current-menu-item")
                    ...
                    $(this)
                      .parent(".akea-bullet-anchor")
                      .attr("data-anchor-section", section_id);
                  } else if (
  ...
  var akea_sticky_navigation = function () {
    ...
    if (t.sticky_nav.hasClass("akea-sticky-navigation-height")) {
      ...
      window.akea_anchor_offset = parseInt(
  ...
  akea_sticky_navigation.prototype = {
      ...
      $(window).on("scroll akea-set-sticky-navigation", function () {
        ...
        if (!t.sticky_nav.hasClass("akea-fixed-navigation")) {
          if ($(window).scrollTop() + page_offset > t.sticky_nav.offset().top) {
            ...
            setTimeout(function () {
              t.sticky_nav.addClass("akea-animate-fixed-navigation");
            }, 10);
            setTimeout(function () {
          ...
          if ($(window).scrollTop() + page_offset <= placeholder.offset().top) {
            ...
            setTimeout(function () {
              t.sticky_nav.removeClass("akea-animate-fixed-navigation");
            }, 10);
            setTimeout(function () {
              t.sticky_nav.css("height", "");
              $(window).trigger("akea-navigation-slider-bar-animate");
        ...
        if (!t.sticky_nav.hasClass("akea-fixed-navigation")) {
          if (
            ...
            t.sticky_nav.addClass(
              "akea-fixed-navigation akea-animate-fixed-navigation"
            );
          ...
          if (
            $(window).scrollTop() + page_offset <=
            placeholder.offset().top + placeholder.height() + 200
          ) {
    ...
    style_mobile_slide: function () {
      var t = this;
      var placeholder = $(
        '<div class="akea-sticky-mobile-placeholder" ></div>'
      );
        ...
        if (
          ...
          if (!t.mobile_menu.hasClass("akea-fixed-navigation")) {
            if (
              ...
              placeholder
                .height(t.mobile_menu.outerHeight())
                .insertAfter(t.mobile_menu);
  ...
  $(document).ready(function () {
    ...
    $(
      "#akea-main-menu, #akea-right-menu, #akea-mobile-menu, #akea-top-bar-menu"
    ).each(function () {
    ...
    $(
      ".akea-header-boxed-wrap, .akea-header-background-transparent, .akea-navigation-bar-wrap.akea-style-transparent"
    ).each(function () {
    ...
    $("body.error404, body.search-no-results").each(function () {
      ...
      var body_wrap_offset = parseInt(
        $(this)
          .children(".akea-body-outer-wrapper")
          .children(".akea-body-wrapper")
          .css("margin-bottom")
      );
  ...
  $(window).load(function () {
    ...
    $("#akea-fixed-footer").each(function () {
      ...
      $("body").css(
        "min-height",
        $(window).height() - parseInt($("html").css("margin-top"))
      ); // for safari
      $(window).resize(function () {
        placeholder.height(fixed_footer.outerHeight());
        $("body").css(
        ...
        _initAnchors: function () {
          ...
          r.$body.on(o.click + "-oncanvas", "a[href]", function (s) {
            ...
            if (
              ...
              h && s.preventDefault(),
                t.__valueOrFn(t.opts.onClick.close, a, h) && t.close();
            }
          });
        },
 ...
 * mmenu.frebsite.nl
 *
 * Copyright (c) Mostafa Mahmoud El-sherbiniy
 */,
  (function (e) {
    var t = "mmenu",
      n = "offCanvas";
        ...
        return this.each(function () {
          ...
          return n
            ? ((s = t.find(n.popUpSelector).parent("li")),
              ...
              n.$path
                .removeClass(n.hoverClass + " " + o.bcClass)
